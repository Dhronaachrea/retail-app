...
public class DrawAdapterPortrait extends RecyclerView.Adapter<DrawAdapterPortrait.DrawAdapterViewHolder> {
    ...
    public DrawAdapterPortrait(Context context, ArrayList<DrawFetchGameDataResponseBean.ResponseData.GameRespVO.DrawRespVO> listDraws, int maxAdvanceDraws) {
    ...
    @NonNull
    @Override
    public DrawAdapterPortrait.DrawAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DrawAdapterPortrait.DrawAdapterViewHolder holder, int position) {
