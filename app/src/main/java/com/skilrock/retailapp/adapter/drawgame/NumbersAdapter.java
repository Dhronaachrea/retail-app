...
public class NumbersAdapter extends RecyclerView.Adapter<NumbersAdapter.GameViewHolder> implements AppConstants {
    ...
    private BallClickListenerLandscape listener;
    ...
    public NumbersAdapter(ArrayList<DrawFetchGameDataResponseBean.ResponseData.GameRespVO.NumberConfig.Range.Ball> listNumber,
                          Activity context, BallClickListenerLandscape listener, ArrayList<String> listQpNumbers,
    ...
    public void onBindViewHolder(@NonNull GameViewHolder holder, int position) {
        ...
        if (listener.isQpSelected()  && listQpNumbers!= null) {
        ...
        holder.tvNumber.setOnClickListener(v -> {
           /* if (listener.isQpSelected()) {
                listener.resetGameToManual();
                return;
            } */
