...
public class SpinAndWinNestedSchemaAdapter extends RecyclerView.Adapter<SpinAndWinNestedSchemaAdapter.GameViewHolder> implements AppConstants {
    ...
    public SpinAndWinNestedSchemaAdapter(ArrayList<DrawFetchGameDataResponseBean.ResponseData.GameRespVO.GameSchemas.MatchDetail> matchDetail, Context context) {
