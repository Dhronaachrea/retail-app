...
public class InventoryFlowReportAdapterClosingBalance extends RecyclerView.Adapter<InventoryFlowReportAdapterClosingBalance.InventoryFlowViewHolder> {

    private ArrayList<InventoryFlowReportResponseBean.GameWiseClosingBalanceDatum> closingBalanceGameWiseData;
    private Context context;

    public InventoryFlowReportAdapterClosingBalance(ArrayList<InventoryFlowReportResponseBean.GameWiseClosingBalanceDatum> closingBalanceGameWiseData, Context context) {
        this.closingBalanceGameWiseData   = closingBalanceGameWiseData;
    ...
    public void onBindViewHolder(@NonNull InventoryFlowViewHolder holder, int position) {
        InventoryFlowReportResponseBean.GameWiseClosingBalanceDatum gameData = closingBalanceGameWiseData.get(position);
    ...
    public int getItemCount() {
        return closingBalanceGameWiseData.size();
    }
    ...
    public void clear() {
        closingBalanceGameWiseData.clear();
