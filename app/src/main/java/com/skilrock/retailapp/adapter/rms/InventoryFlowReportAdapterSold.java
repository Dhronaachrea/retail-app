...
public class InventoryFlowReportAdapterSold extends RecyclerView.Adapter<InventoryFlowReportAdapterSold.InventoryFlowViewHolder> {

    private ArrayList<InventoryFlowReportResponseBean.GameWiseDatum> gameWiseData;
    private Context context;

    public InventoryFlowReportAdapterSold(ArrayList<InventoryFlowReportResponseBean.GameWiseDatum> gameWiseData, Context context) {
    ...
    public void onBindViewHolder(@NonNull InventoryFlowViewHolder holder, int position) {
        ...
        holder.tvGameDataBooks.setText((gameData.getSoldBooks().toString()));
        holder.tvGameDataTickets.setText((gameData.getSoldTickets().toString()));
    }
