...
import com.skilrock.retailapp.adapter.drawgame.BetAmountDialogAdapter;
...
public class BetAmountDialog extends Dialog implements View.OnClickListener, BetAmountDialogAdapter.OnAmountSelectionListener {
    ...
    public BetAmountDialog(Context context, ArrayList<FiveByNinetyBetAmountBean> listAmount, OnAmountUpdatedListener listener) {
        super(context);
    ...
    private void initializeWidgets() {
        ...
        BetAmountDialogAdapter adapter = new BetAmountDialogAdapter(context, listAmount, this);
        ...
        switch (view.getId()) {
            case R.id.btn_submit:
                if (SELECTED_AMOUNT == -1) {
                    ...
                    listener.onAmountChange(SELECTED_AMOUNT);
                    dismiss();
                }
                break;
            case R.id.btn_cancel:
                listener.onAmountChange(-1);
                dismiss();
                break;
        }
    }
