...
public class CancelTicketConfirmationDialog extends Dialog implements
        View.OnClickListener {

    private Context context;
    private ConfirmationListener listener;

    public CancelTicketConfirmationDialog(Context context, ConfirmationListener listener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_cancel_ticket_confirmation);
        initializeWidgets();
    }
