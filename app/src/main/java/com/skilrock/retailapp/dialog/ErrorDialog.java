...
public class ErrorDialog extends Dialog implements
    ...
    public ErrorDialog(Context context, String header, String message) {
        super(context);
    ...
    public ErrorDialog(Context context, String header, String message, boolean isPerformLogout) {
        super(context);
        this.context            = context;
        this.header             = header;
        this.message            = message;
    ...
    public ErrorDialog(Context context, String header, String message, boolean isPerformLogout, Activity activity) {
        super(context);
        this.context            = context;
        this.header             = header;
        this.message            = message;
    ...
    public ErrorDialog(Context context, String header, String message, int popCount, FragmentManager fragmentManager) {
        super(context);
        this.context            = context;
        this.header             = header;
        this.message            = message;
    ...
    public ErrorDialog(Context context, String header, String message, ErrorDialogListener errorDialogListener) {
        super(context);
        this.context                = context;
        this.header                 = header;
        this.message                = message;
