...
public class LanguageSelectionUkrainDialog extends Dialog implements
        View.OnClickListener, AppConstants {

    private Activity context;
    private TextView tvEnglish, tvUkrain;
    private Button btnDone;
    private String selectedLanguage;
    private EventListener listener;

    public LanguageSelectionUkrainDialog(Activity activity, EventListener listener) {
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_language_selection_ukrain);
        initializeWidgets();
    }
    ...
    private void initializeWidgets() {
        ...
        tvUkrain   = findViewById(R.id.tvUkrain);
        ...
        tvUkrain.setOnClickListener(this);
        btnDone.setOnClickListener(this);

        switch (SharedPrefUtil.getLanguage(context)) {
            
            case LANGUAGE_UKRAIN:
                selectedLanguage = tvUkrain.getTag().toString();
                setClickOperation(tvUkrain);
                break;
            default:
    ...
    private void setClickOperation (TextView textView) {
        tvUkrain.setTextColor(ContextCompat.getColor(context, R.color.colorLightGrey_2));
        tvEnglish.setTextColor(ContextCompat.getColor(context, R.color.colorLightGrey_2));

        tvUkrain.setTextSize(TypedValue.COMPLEX_UNIT_SP,16);
