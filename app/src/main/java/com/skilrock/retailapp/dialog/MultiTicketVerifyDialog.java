...
public class MultiTicketVerifyDialog extends Dialog implements View.OnClickListener {

    private final Context context;
    private MultiSaleTicketAdapter mAdapter;
    private SaleTicketGelsaFragment.DialogCallback callback;
    public MultiTicketVerifyDialog(Context context, SaleTicketGelsaFragment.DialogCallback callback) {
        super(context);
