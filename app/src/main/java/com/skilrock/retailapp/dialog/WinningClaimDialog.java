...
public class WinningClaimDialog extends Dialog implements
    ...
    private WinningClaimVerifyResponseBean bean;
    private boolean showBalanceErrorNote;
    private String dotFormatter;
    private String amountFormatter;


    public WinningClaimDialog(Context context, WinningClaimListener listener, String header, boolean isVerify, WinningClaimVerifyResponseBean bean, boolean showBalanceErrorNote) {
        super(context);
    ...
    private void initializeWidgets() {
        ...
        tvTicketNumber.setText(bean.getResponseData().getTicketNumber());
        winAmount = Utils.getBalanceToView(bean.getResponseData().getWinClaimAmount(), dotFormatter, amountFormatter, 0);
