...
import static com.skilrock.retailapp.utils.Utils.getBalanceToView;
import static com.skilrock.retailapp.utils.Utils.getBalanceToViewSbs;
import static com.skilrock.retailapp.utils.Utils.getDecimalPlacesSbs;
import static com.skilrock.retailapp.utils.Utils.getFormattedAmount;

public class WinningClaimDialogSbs extends Dialog implements
        View.OnClickListener {
    private Context context;
    private String header;
    private boolean isVerify;
    private WinningClaimListener listener;
    private SbsWinVerifyResponse bean;
    private boolean showBalanceErrorNote;
    private String dotFormatter;
    private String amountFormatter;
    private String winAmount = " ";
    private int decimalDegits = 0;

    public WinningClaimDialogSbs(Context context, WinningClaimListener listener, String header, boolean isVerify, SbsWinVerifyResponse bean, boolean showBalanceErrorNote) {
        super(context);
    ...
    private void initializeWidgets() {
        ...
        tvTicketNumber.setText(bean.getResponseData().getData().getTicketNo());

        winAmount = getBalanceToViewSbs(bean.getResponseData().getData().getTicket().getPayoutAmount(), ",", " ", getDecimalPlacesSbs(bean.getResponseData().getData().getTicket().getPayoutAmount()));
