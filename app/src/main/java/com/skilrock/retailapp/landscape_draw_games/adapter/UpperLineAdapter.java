...
public class UpperLineAdapter extends RecyclerView.Adapter<UpperLineAdapter.GameViewHolder> implements AppConstants {

    private ArrayList<BankerBean> listNumber;
    private Context context;

    public UpperLineAdapter(ArrayList<BankerBean> listNumber, Context context) {
