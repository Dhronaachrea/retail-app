...
public class BillPaymentsResponseBean {
    ...
    public static class ResponseData {
        ...
        public static class Data {
            ...
            public String toString() {
                return "Data{" + "date='" + date + '\'' + ", adjustedAmount='" + adjustedAmount + '\'' + ", paymentTransactionId='" + paymentTransactionId + '\'' + '}';
            }
        }
    ...
    @Override
    public String toString() {
        return "BillPaymentsResponseBean{" + "responseCode=" + responseCode + ", responseMessage='" + responseMessage + '\'' + ", responseData=" + responseData + '}';
    }
}
