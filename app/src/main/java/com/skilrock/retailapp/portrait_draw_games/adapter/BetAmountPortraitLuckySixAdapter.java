...
public class BetAmountPortraitLuckySixAdapter extends RecyclerView.Adapter<BetAmountPortraitLuckySixAdapter.GameViewHolder> implements AppConstants {

    private Context context;
    private OnBetAmountClickListener clickListener;
    private ArrayList<FiveByNinetyBetAmountBean> listBetAmounts;

    public BetAmountPortraitLuckySixAdapter(ArrayList<FiveByNinetyBetAmountBean> listBetAmounts, Context context, OnBetAmountClickListener clickListener) {
