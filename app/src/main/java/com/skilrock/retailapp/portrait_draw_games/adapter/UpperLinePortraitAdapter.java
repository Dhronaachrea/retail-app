...
public class UpperLinePortraitAdapter extends RecyclerView.Adapter<UpperLinePortraitAdapter.GameViewHolder> implements AppConstants {

    private ArrayList<BankerBean> listNumber;
    private Context context;

    public UpperLinePortraitAdapter(ArrayList<BankerBean> listNumber, Context context) {
