...
public class WinningClaimSbsLandActivity extends BaseActivity implements View.OnClickListener, WinningClaimListener, SurfaceHolder.Callback {
    ...
    private WinningClaimSbsLandActivity.AsyncDecode asyncDecode;
    ...
    private void setInitialParameters() {
        ...
        if (bundle != null) {
            ...
            WinningClaimSbsLandActivity.this.finish();
        }
    }
    ...
    private void callReprint() {
        ProgressBarDialog.getProgressDialog().showProgress(WinningClaimSbsLandActivity.this);
    ...
    private void initializeWidgets() {
        ...
        buttonProceed.setOnClickListener(WinningClaimSbsLandActivity.this);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (ed_fourth_no.getText().toString().length() == 0) {
                    ...
                    if (ed_first_no.getText().toString().length() == 4 && ed_second_no.getText().toString().length() == 4 &&
                        ...
                        Utils.showRedToast(WinningClaimSbsLandActivity.this, getString(R.string.enter_valid_ticket_number));
                    }
                }
            }
    ...
    private void setFocus(EditText editText) {
        ed_first_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit_dull));
        ed_second_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit_dull));
        ed_third_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit_dull));
        ed_fourth_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit_dull));
        editText.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit));
    ...
    private void resetEditTexts() {
        ...
        ed_first_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsLandActivity.this, R.drawable.epl_bg_edit));
    ...
    private void onScanned(String result) {
        ...
        if (scannedValue.length() == 16) {
            ...
            Utils.vibrate(WinningClaimSbsLandActivity.this);
        }
    }
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (ContextCompat.checkSelfPermission(Objects.requireNonNull(this), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            AppPermissions.showMessageOKCancel(WinningClaimSbsLandActivity.this, getString(R.string.allow_permission), this, ed_first_no);
                        ...
                        Utils.showRedToast(WinningClaimSbsLandActivity.this, getString(R.string.permission_storage_denied));
                        WinningClaimSbsLandActivity.this.finish();
                    }
                    break;
                }
    ...
    Observer<SbsWinVerifyResponse> observerWinSbs = response -> {
        ...
        if (response == null)
            ...
            if (response.getResponseData().getData().getTicket().getPayoutAmount() > 0 && response.getResponseData().getData().getTicket().getStatus().equalsIgnoreCase("READY_FOR_PAYOUT")) {
                ...
                Utils.showCustomErrorDialog(this, getString(R.string.winning_claim), TranslateSbs.getTranslateVal(response.getResponseData().getData().getTicket().getStatus(), WinningClaimSbsLandActivity.this), errorDialogListener);
            }

        } else {
            if (Utils.checkForSessionExpiryActivity(WinningClaimSbsLandActivity.this, response.getResponseCode(), WinningClaimSbsLandActivity.this))
                return;

            String errorMsg = Utils.getResponseMessage(WinningClaimSbsLandActivity.this, "sbs", response.getResponseCode());
            ErrorDialogListener errorDialogListener = this::onDialogClosed;
    ...
    Observer<SbsWinPayResponse> observerWinSbsPay = response -> {
        ...
        if (response == null)
            ...
            if (ticket_no != null) {
                Intent intent = new Intent(WinningClaimSbsLandActivity.this, PrintActivitySbs.class);
    ...
    public void onClickSbsMenuReprint(View view) {
        ...
        Utils.showReprintTicketConfirmationDialog(WinningClaimSbsLandActivity.this, confirmationListener);
    }
