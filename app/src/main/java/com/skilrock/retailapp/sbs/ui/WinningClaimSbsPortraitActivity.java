...
public class WinningClaimSbsPortraitActivity extends BaseActivity implements View.OnClickListener, WinningClaimListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_winning_claim_sbs_potrait);
    ...
    private void initializeWidgets() {
        ...
        buttonProceed.setOnClickListener(WinningClaimSbsPortraitActivity.this);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (ed_fourth_no.getText().toString().length() == 0) {
                    ...
                    if (ed_first_no.getText().toString().length() == 4 && ed_second_no.getText().toString().length() == 4 &&
                        ...
                        Utils.showRedToast(WinningClaimSbsPortraitActivity.this, getString(R.string.enter_valid_ticket_number));
                    }
                }
            }
    ...
    private void setFocus(EditText editText) {
        ed_first_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit_dull));
        ed_second_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit_dull));
        ed_third_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit_dull));
        ed_fourth_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit_dull));
        editText.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit));
    ...
    private void resetEditTexts() {
        ...
        ed_third_no.setText("");
        ed_fourth_no.setText("");
        ed_first_no.setBackground(ContextCompat.getDrawable(WinningClaimSbsPortraitActivity.this, R.drawable.epl_bg_edit));
    ...
    public void onClickBack(View view) {
        ...
        WinningClaimSbsPortraitActivity.this.finish();
    }
    ...
    private void startScanning() {
        ...
        try {
            mCodeScanner = new CodeScanner(WinningClaimSbsPortraitActivity.this, scannerView);
            mCodeScanner.setDecodeCallback(result -> WinningClaimSbsPortraitActivity.this.runOnUiThread(() -> onScanned(result)));
            ...
            Toast.makeText(WinningClaimSbsPortraitActivity.this, "Unable to open scanner", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void onScanned(Result result) {
        ...
        if (scannedValue.length() == 16) {
            ...
            Utils.vibrate(WinningClaimSbsPortraitActivity.this);
        }
    }
                ...
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (ContextCompat.checkSelfPermission(Objects.requireNonNull(this), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                            AppPermissions.showMessageOKCancel(WinningClaimSbsPortraitActivity.this, getString(R.string.allow_permission), this, ed_first_no);
                        ...
                        Utils.showRedToast(WinningClaimSbsPortraitActivity.this, "Permission denied to use Storage");
                        WinningClaimSbsPortraitActivity.this.finish();
                    }
                    break;
    ...
    public void callWiningVerify(String ticket_no) {
        ProgressBarDialog.getProgressDialog().showProgress(WinningClaimSbsPortraitActivity.this);
    ...
    Observer<SbsWinVerifyResponse> observerWinSbs = response -> {
        ...
        if (response == null)
            ...
            if (response.getResponseData().getData().getTicket().getPayoutAmount() > 0 && response.getResponseData().getData().getTicket().getStatus().equalsIgnoreCase("READY_FOR_PAYOUT")) {
                ...
                Utils.showCustomErrorDialog(this, getString(R.string.winning_claim), TranslateSbs.getTranslateVal(response.getResponseData().getData().getTicket().getStatus(), WinningClaimSbsPortraitActivity.this), errorDialogListener);
            }

        } else {
            if (Utils.checkForSessionExpiryActivity(WinningClaimSbsPortraitActivity.this, response.getResponseCode(), WinningClaimSbsPortraitActivity.this))
                return;

            String errorMsg = Utils.getResponseMessage(WinningClaimSbsPortraitActivity.this, "sbs", response.getResponseCode());
            ErrorDialogListener errorDialogListener = this::resetEditTexts;
    ...
    Observer<SbsWinPayResponse> observerWinSbsPay = response -> {
        ...
        if (response == null)
            ...
            if (ticket_no != null) {
                Intent intent = new Intent(WinningClaimSbsPortraitActivity.this, PrintActivitySbs.class);
                intent.putExtra("PrintDataWinning", response);
                intent.putExtra("Category", PrintActivitySbs.WINNING);
    ...
    Observer<SbsReprintResponseBean> observerReprint = response -> {
        ...
        if (response == null)
            ...
            intent.putExtra("Category", PrintActivitySbs.REPRINT);
    ...
    public void onClickSbsMenuReprint(View view) {
        ...
        Utils.showReprintTicketConfirmationDialog(WinningClaimSbsPortraitActivity.this, confirmationListener);
    }
}