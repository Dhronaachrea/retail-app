...
public class GameSleFragment extends Fragment implements View.OnClickListener {
    ...
    public GameSleFragment(Context context, int numberOfColoumn, List<ResultData.DrawResultDataBean.GameDataBean.GameTypeDataBean.DrawDataBean> drawDataBeans, int totalNumberOfMatch){
