...
public class SleGamePlayAdapterNew extends RecyclerView.Adapter<SleGamePlayAdapterNew.SleGamePlayViewHolderNew> {
    ...
    public SleGamePlayAdapterNew(Context context, List<ResultData.DrawResultDataBean.GameDataBean.GameTypeDataBean.DrawDataBean.EventDataBean> evenData, int totalNumberOfMatch){
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
        this.evenData = evenData;
        this.totalNumberOfMatch = totalNumberOfMatch;
    }
    public SleGamePlayAdapterNew(Context context, List<SleFetchDataB2C.SleDataBean.GameDataBean.GameTypeDataBean.DrawDataBean.EventDataBean> evenDataB2C, int totalNumberOfMatch, boolean isB2C){
        this.context = context;
        layoutInflater = LayoutInflater.from(context);
    ...
    public SleGamePlayViewHolderNew onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (Utils.getDeviceName().equalsIgnoreCase(AppConstants.DEVICE_V2PRO))
            view = layoutInflater.inflate(R.layout.item_five_new_v2pro,null,false);
        else
         view = layoutInflater.inflate(R.layout.item_five_new,null,false);
    ...
    public void onBindViewHolder(@NonNull SleGamePlayViewHolderNew holder, int position) {
        ...
        if(isB2C){
            ...
            sleGamePlayViewHolder.txt_time.setText(evenDataB2C.get(position).getEventDate().split(" ")[1]);
        }else{
    ...
    public class SleGamePlayViewHolderNew extends RecyclerView.ViewHolder{
        ...
        private TextView txt_home,txt_away,txt_venue,numbers,txt_time;
        ...
        public SleGamePlayViewHolderNew(@NonNull View itemView) {
            ...
            if(totalNumberOfMatch == 3){
                ...
                cb_home_extra.setText("HOME");
                cb_draw.setText("DRAW");
                cb_away_extra.setText("AWAY");
