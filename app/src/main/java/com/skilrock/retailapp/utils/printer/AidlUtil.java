package com.skilrock.retailapp.utils.printer;
...
public class AidlUtil implements ICallback {
   ...
   /* public void sendRawData1(byte[] data, ICallback printActivityResult) {
        if (woyouService == null) {
            Toast.makeText(context,"Print failed", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            woyouService.sendRAWData(data, printActivityResult);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }*/
